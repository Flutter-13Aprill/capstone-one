        ...
        return AlertDialog(
          ...
          actions: [
            ...
            ElevatedButton(
              ...
              child: Text("Logout".tr(),style: Theme.of(context).textTheme.titleSmall!.copyWith(fontSize: 14),),
            ),
          ],
        );
      },
        ...
        child: ListView(
          ...
          children: <Widget>[
            ...
            ListTile(
              ...
              title: Text(
                "about".tr(),
                style:isDarkThem? Theme.of(context).textTheme.titleSmall:Theme.of(context).textTheme.bodyMedium,
              ),
              onTap: () {
                ...
                showAboutDialog(
                  ...
                  children: <Widget>[
                    Text(
                      "ourapp".tr(),
                      style:isDarkThem? Theme.of(context).textTheme.bodyMedium:Theme.of(context).textTheme.headlineLarge,
                    ),
                    SizedBox(height: 8),
