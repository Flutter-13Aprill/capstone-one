import 'package:app/controllar/login_controllar.dart';
...
class _LoginScreenState extends State<LoginScreen> {
  ...
  LoginControllar controlarLogIn = LoginControllar();
                ...
                child: Column(
                  ...
                  children: [
                    Padding(
                      ...
                      child: Text(
                        ...
                        style:
                            Theme.of(context)
                                .textTheme
                                .headlineLarge, // Large headline text style
                      ),
                    ),
                    TextFormFieldRegister(
                      controller:
                          emailControllar, // Assign the email controller.
                    ...
                    TextFormFieldRegister(
                      ...
                      controller:
                          passwordControllar, // Assign the email controller.

                      lable: "password", // Label for the email field.
                    ),
                    Center(
                      child: Button(
                        //button  with title and on press
                        title: "login",
                        onPressed: () {
                          controlarLogIn.submitForm(
                            context: context,
                            formKey: _formKey,
                            emailControllar: emailControllar,
                            passwordControllar: passwordControllar,
                          );
                      ...
                      children: [
                        Text(
                          ...
                          style: //style depend on isDarkThem
                              controlarLogIn.isDarkThemTrue(context: context),
                        ),
                        SizedBox(width: 4),
                        InkWell(
                          onTap: () {
