...
class CustomCardFav extends StatefulWidget {
  const CustomCardFav({super.key, required this.produt, this.remove});
  final ProductData produt;
  final void Function()? remove;

  @override
  State<CustomCardFav> createState() => _CustomCardState();
}

class _CustomCardState extends State<CustomCardFav> {
  @override
            ...
            Padding(
              ...
              child: Row(
                children: [
                  CustomElvatedButton(
                    press: () {
                      ListProduct.caetProdut.add(widget.produt);
                    },
